...
# write on the page
st.write("La precipitación es un factor fundamental en el estudio del clima y el entorno atmosférico. En Cuba, las lluvias tienen un impacto significativo en la vida cotidiana, la agricultura, la ecología y muchos otros aspectos de la sociedad. Con el objetivo de proporcionar una comprensión detallada de las precipitaciones en la isla caribeña, nuestra plataforma ofrece un análisis exhaustivo de los datos pluviométricos recopilados a lo largo de los últimos años.")
